...
public class RegisterGUI extends JDialog {
	...
	public RegisterGUI() {
			...
			DeleteButton.addActionListener((new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (UserName.length() == 0 || Password.length() == 0) {
						...
						boolean rtn = true;
						// *****needs to be modified
						rtn = Globals.clnt.deleteUser(UserName, new String(Password));
				...
				.setHorizontalGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPanel.createSequentialGroup().addContainerGap()
								.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
										.addComponent(RegisterPasswordLabel).addComponent(RegisterNewNameLabel))
								.addGap(45)
								.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
										.addComponent(PasswordtextField, GroupLayout.PREFERRED_SIZE, 213,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(NametextField, GroupLayout.PREFERRED_SIZE, 213,
												GroupLayout.PREFERRED_SIZE)
		...
		gl_contentPanel.setVerticalGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPanel
				.createSequentialGroup().addComponent(userAccountLabel).addGap(23)
				.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).addComponent(RegisterNewNameLabel)
						.addComponent(NametextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_contentPanel.createSequentialGroup().addGap(16).addComponent(RegisterPasswordLabel))
						.addGroup(gl_contentPanel.createSequentialGroup().addGap(18).addComponent(PasswordtextField,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
				.addPreferredGap(ComponentPlacement.RELATED).addComponent(RegisterWarningMessage).addGap(36)));
